...
---@param err nil | string nil on success or reason of error
---@param uri string Help file URI
---@param pattern string (optional) move cursor to line matching regex pattern
...
---@param index integer The item to get from the quickfix list
...
---@param err nil | string nil if no error otherwise string
...
---@param concurrent_jobs integer Number of parallel jobs (default: 8)
